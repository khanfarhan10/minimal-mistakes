...
sidebar:
  - title: "View Code on Github"
    ...
    text: "View the source files on github."
  - title: "Another Title"
    text: "More text here."
    nav: sidebar-sample
---
...
```python
correlation_matrix = df.corr().round(2) #default method is : ‘pearson’, also available : ‘kendall’, ‘spearman’ correlation coefficient
